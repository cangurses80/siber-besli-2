...
assert.match(shotScript, /01-gate-top\.png[\s\S]*08-nickname\.png/, 'Sekiz sabit QA görüntüsü üretilmeli');
...
console.log('  Progress, Firebase kalıcılığı, güvenlik sınırları ve sekiz QA kontrolü: tamam');
